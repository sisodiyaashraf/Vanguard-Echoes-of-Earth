...
class CuratorHero extends BaseHero {
  static const double runGroundOffset = 15.0;
  ...
  Future<void> onLoad() async {
    ...
    final superpowerAnimation = await loadHorizontalAnimation(
      'characters/Curator — Temporal Nanotech(superpower).png',
      3,
      0.15,
    );
    ...
    final transformationAnimation = await loadHorizontalAnimation(
      'characters/Curator — Temporal Nanotech(transformation).png',
      4,
      0.15,
    );
